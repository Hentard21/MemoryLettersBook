...
- `standard`: **58**.
- `extended`: **16**.
- Длина читательской расшифровки уже доступна для **70** семей.
- Физическая рукопись не зарегистрирована в активном манифесте у **4** семей: `hero-006`, `hero-058`, `hero-065`, `hero-069`.
